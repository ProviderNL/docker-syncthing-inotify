...
ENV SYNCTHING_INOTIFY_TARBALL syncthing-inotify-linux-amd64-$SYNCTHING_INOTIFY_VERSION.tar.gz
...
RUN set -x \
    && curl -fSL "https://github.com/syncthing/syncthing-inotify/releases/download/$SYNCTHING_INOTIFY_VERSION/$SYNCTHING_INOTIFY_TARBALL" -O \
